...
namespace MeLevaAi.Api.Controllers
{
    ...
    public class CorridaController : Controller
    {
        ...
        public readonly AvaliacaoService _avaliacaoService;

        public CorridaController()
        {
            _corridaService = new();
            _avaliacaoService = new();
        }
        ...
        [HttpPost("avaliar")]
        [ProducesResponseType(StatusCodes.Status200OK, Type = typeof(AvaliacaoResponse))]
        [ProducesResponseType(StatusCodes.Status404NotFound, Type = typeof(ErrorResponse))]
        public ActionResult<Avaliacao?> Avaliar([FromBody] AvaliacaoRequest request)
        {
            var response = _avaliacaoService.Cadastrar(request);
